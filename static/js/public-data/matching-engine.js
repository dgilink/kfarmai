(function () {
  ...
  var MATCH_CASES = [
    ...
    },
    {
      ...
      sources: ['ncpms', 'psis', 'agriWeather', 'cropGuide', 'localAgency'],
      sourceEvidence: {
        ncpms: 'NCPMS 고추 탄저병 공공자료에 AI 결과와 유사한 과실·잎 병반 항목이 있습니다. 링크에서 증상 사진과 발생환경을 확인하세요.',
        psis: '농약안전정보에서 고추·탄저병 등록 여부와 제품 라벨 기준 확인이 필요합니다. 사용 판단은 전문기관 상담과 공식 기준을 함께 보세요.',
        agriWeather: '탄저병은 비·습도 등 다습 조건과 함께 확인합니다. 최근 강수, 습도, 시설 환기 상태를 농업날씨와 비교하세요.',
        cropGuide: '재배가이드·재배달력에서 병든 부위 정리, 통풍, 과습 관리, 시기별 관리 포인트를 확인하세요.',
        localAgency: '사진, 발생 시기, 최근 강우·습도 정보를 정리해 농업기술센터 등 관계기관 확인을 권장합니다.'
      }
    },
    {
      id: 'tomato-spot',
