(function () {
  ...
  var MATCH_CASES = [
    ...
    },
    {
      ...
      sources: ['ncpms', 'psis', 'agriWeather', 'cropGuide', 'localAgency'],
      sourceEvidence: {
        ncpms: 'AI가 잡은 과실 병반·탄저병 후보는 고추 탄저병 공공자료의 증상 조건과 유사합니다.',
        psis: '탄저병 가능성이 있으므로 농약 사용 여부는 고추 등록 병해충과 안전사용기준 확인이 필요한 단계입니다.',
        agriWeather: '최근 비·높은 습도·환기 부족 조건이 있었다면 탄저병 발생환경과 맞물릴 수 있습니다.',
        cropGuide: '병든 과실·잎이 남아 있거나 통풍이 약하면 병 확산 위험을 높일 수 있어 정리와 환기 관리가 필요합니다.',
